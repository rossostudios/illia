      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm">
              AI-powered lead generation for Charleston businesses. Find, score, and convert high-intent prospects.
            </p>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/playground" className="text-gray-400 hover:text-green-400 transition-colors">Playground</Link></li>
              <li><Link href="/integrations" className="text-gray-400 hover:text-green-400 transition-colors">Integrations</Link></li>
              <li><Link href="/api" className="text-gray-400 hover:text-green-400 transition-colors">API</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/guides" className="text-gray-400 hover:text-green-400 transition-colors">Guides</Link></li>
              <li><Link href="/changelog" className="text-gray-400 hover:text-green-400 transition-colors">Changelog</Link></li>
              <li><a href="https://github.com/illia" className="text-gray-400 hover:text-green-400 transition-colors">Open Source</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/partners" className="text-gray-400 hover:text-green-400 transition-colors">Partners</Link></li>
              <li><Link href="/press" className="text-gray-400 hover:text-green-400 transition-colors">Press</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="py-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div>
              <h3 className="text-lg font-semibold mb-1">Stay updated with our newsletter</h3>
              <p className="text-sm text-gray-400">Get the latest tips on lead generation and AI automation</p>
            </div>
            <form className="flex gap-2 w-full md:w-auto">
              <input
                type="email"
                placeholder="Enter your email"
                className="px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-green-500 flex-1 md:w-64"
              />
              <button
                type="submit"

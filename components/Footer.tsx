      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-teal-400">Illia</h3>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <form className="flex gap-2 w-full md:w-auto">
              <input
                ...
                className="px-4 py-2 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-teal-500 flex-1 md:w-64"
              />
              <button
                type="submit"
                className="px-6 py-2 bg-teal-600 hover:bg-teal-700 text-white font-semibold rounded-lg transition-colors duration-300 ease-in-out"
              >
                Subscribe
              </button>
            </form>

        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm">
              AI-powered lead generation for Charleston businesses. Find, score, and convert
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/docs" className="text-gray-400 hover:text-green-400 transition-colors">
                  Documentation
                </Link>
              </li>
              <li>

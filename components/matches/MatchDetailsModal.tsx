                ...
                <div className="flex items-center space-x-4">
                  <div className="relative h-16 w-16 overflow-hidden rounded-full">
                    <Image
                      ...
                      fill
                      sizes="64px"
                      src={match.provider.avatar_url || 'https://i.pravatar.cc/150?img=3'}
                    />
                  </div>
                  <div>
                ...
                <div className="space-y-6 lg:col-span-2">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                        <DollarSign className="h-4 w-4" />${(match.provider as any).hourlyRate || 'N/A'}/hour
                      </div>
                      <div className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                        <Star className="h-4 w-4 text-yellow-400" />
                        {match.provider.rating} ({(match.provider as any).reviews || 0} reviews)
                      </div>
                      <div className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
                        <Clock className="h-4 w-4" />
                        {(match.provider as any).experience || 'N/A'}
                      </div>
                    </div>
                    <div className="mt-3 flex flex-wrap gap-2">
                      {((match.provider as any).languages || []).map((lang: string) => (
                        <span
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {match.timeline.map((event, index) => {
                        const Icon = timelineIconMap[event.type as keyof typeof timelineIconMap] || Clock
                        return (
                    ...
                    {showAddNote && (
                      <div className="mb-3 space-y-2">
                        ...
                        <div className="flex gap-2">
                          <Button onClick={handleAddNote} size="sm" variant="primary">
                            Save Note
                          </Button>
                          <Button
                            onClick={() => {

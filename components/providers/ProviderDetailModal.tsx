...
export function ProviderDetailModal({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative z-[9999] w-full max-w-3xl h-[85vh] overflow-hidden rounded-lg bg-white shadow-xl dark:bg-gray-900 flex flex-col">
        {/* Header */}
        <div className="border-gray-200 border-b px-6 py-4 dark:border-gray-700 flex-shrink-0">
          ...
          <div className="mb-6 flex items-start gap-4">
            ...
            <div className="mb-6 grid grid-cols-2 gap-4">
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="text-gray-600 dark:text-gray-400">
                  {provider.years_experience ? `${provider.years_experience} years experience` : 'Experience not specified'}
                </span>
              </div>
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <span className="text-gray-600 dark:text-gray-400">
                  {provider.rate_hourly ? `$${provider.rate_hourly}/hour` : 'Rate negotiable'}
                </span>
              </div>

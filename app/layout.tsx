...
export const metadata: Metadata = {
  ...
  description: "Connect with trusted home services in Medellín and Florianópolis. Find cleaners, cooks, and more through our expat community platform.",
  keywords: ["expat services", "Medellín", "Florianópolis", "home services", "cleaners", "cooks", "expat community"],
  openGraph: {
